...
```hcl
module "network" {
  source = "git::https://github.com/EluminaGroup/terraform-aws-network.git?ref=0.0.3"
...
Apache 2 Licensed. See [LICENSE](https://github.com/EluminaGroup/terraform-aws-network/blob/master/LICENSE) for full details.
